...
import PayRetroAccountsDashboard from './components/PayRetroaccountsDashboard';

export class AccountsDashboard extends React.Component<any> {
  componentDidMount() {
